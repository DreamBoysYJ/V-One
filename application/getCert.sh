...
# Copy the MSP for USERORG.
mkdir -p ${DIR}/msp/userorg.example.com/users/signcerts
mkdir -p ${DIR}/msp/userorg.example.com/users/keystore
cp "${DIR}/../network/organizations/peerOrganizations/userorg.example.com/users/User1@userorg.example.com/msp/signcerts/"* "${DIR}/msp/userorg.example.com/users/signcerts/User1@userorg.example.com-cert.pem"
cp "${DIR}/../network/organizations/peerOrganizations/userorg.example.com/users/User1@userorg.example.com/msp/keystore/"* "${DIR}/msp/userorg.example.com/users//keystore/priv_sk"
{ set +x; } 2>/dev/null